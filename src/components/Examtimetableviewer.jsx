                ...
                <div class="sheet">
                    ...
                    <div class="sheet-header">
                        ...
                        <p>
                            ...
                            subject${classSchedule.length === 1 ? '' : 's'}
                            scheduled
                        </p>
                    </div>
            ...
            {step === 'select' ? (
                ...
                <div className="etv-page etv-fade-in">
                    ...
                    <div className="etv-hero">
                        ...
                        <p>
                            Choose a class to view its published
                            exam timetable
                        </p>
                    ...
                    {loading ? (
                        ...
                        <div className="etv-empty">
                            ...
                            <h4>
                                No Timetables Published Yet
                            </h4>

                            <p>
                                Once an exam timetable is added
                                for a class, it will appear here.
                            </p>
                        ...
                        <div className="etv-class-selector">
                            ...
                            <div className="etv-select-hint">
                                <BookOpen size={13} />

                                <span>
                                    Select your class to view
