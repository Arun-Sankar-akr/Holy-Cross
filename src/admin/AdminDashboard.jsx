...
import {
    ...
    Edit2, Check, X, ArrowLeft, Folder, UserCheck, KeyRound, Clock, BookOpen
} from 'lucide-react';
...
export default function AdminDashboard() {
    ...
    const handleAddStudentTimetable = async (e) => {
        e.preventDefault();
        if (!selectedClass || !selectedSection || !studentTimetableForm.subject || !studentTimetableForm.timeSlot) return;

        await handlePublish('student_timetables', {
            className: selectedClass,
            sectionName: selectedSection.name,
            day: studentTimetableForm.day || 'Monday',
    ...
    const handleUpdateStudentTimetable = async (id) => {
        try {
            await updateDoc(doc(db, 'student_timetables', id), {
                day: editStudentTTForm.day,
                timeSlot: editStudentTTForm.timeSlot,
                subject: editStudentTTForm.subject,
                teacherName: editStudentTTForm.teacherName,
                roomNo: editStudentTTForm.roomNo
            });
                    ...
                    <nav className="admin-tabs">
                        ...
                        {updatesOpen && (
                            <div className="submenu-container">
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'calendar' ? 'active' : ''}`}
                                ...
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'admins' ? 'active' : ''}`}
                                ...
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'toppers' ? 'active' : ''}`}
                                ...
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'gallery' ? 'active' : ''}`}
                                ...
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'holidays' ? 'active' : ''}`}
                                ...
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'announcements' ? 'active' : ''}`}
                        ...
                        {erpOpen && (
                            <div className="submenu-container">
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'staff' ? 'active' : ''}`}
                                ...
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'students' ? 'active' : ''}`}
                                    onClick={() => {
                        ...
                        {timetableOpen && (
                            <div className="submenu-container">
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'student_timetable' ? 'active' : ''}`}
                                    onClick={() => {
                                        setActiveTab('student_timetable');
                                        setSelectedClass(null);
                                        setSelectedSection(null);
                                    }}
                                >
                                ...
                                <button
                                    type="button"
                                    className={`admin-tab child-tab ${activeTab === 'staff_timetable' ? 'active' : ''}`}
                                    onClick={() => setActiveTab('staff_timetable')}
                                >
                                    <Clock size={17} /> Staff Timetable
                                </button>
                            </div>
                        )}
                    </nav>
